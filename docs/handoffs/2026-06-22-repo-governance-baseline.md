# Handoff — 2026-06-22 — base120 repo governance baseline

## Purpose

Record the adoption of the HUMMBL Repo Standard v0.1 artifact stack for `hummbl-dev/base120` as part of the 7/15 cluster rollout.
...
- Added `CONSTITUTION.md` — 8 protected invariants, authority, receipt-triggering changes, amendment.
